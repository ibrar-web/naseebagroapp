    ...
    >
      ...
      >
        ...
        <View style={styles.fieldGroup}>
          ...
          <TouchableOpacity
            onPress={() => setShowBizTypePicker(v => !v)}
          ...
          {showBizTypePicker && (
            <View style={styles.pickerCard}>
              {BIZ_TYPES.map(type => (
                <TouchableOpacity
                  key={type}
                  onPress={() => { setForm(p => ({ ...p, businessType: type })); setShowBizTypePicker(false); }}
                  style={[styles.pickerItem, form.businessType === type && styles.pickerItemActive]}
                  activeOpacity={0.7}
                >
                  <Text style={[styles.pickerItemText, form.businessType === type && styles.pickerItemTextActive]}>
                    {type}
                  </Text>
                </TouchableOpacity>
              ))}
